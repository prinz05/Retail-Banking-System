...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ExceptionDetails> handleInvalidAmountException(InvalidAmountException e) {
		...
		ExceptionDetails response = new ExceptionDetails(LocalDateTime.now(), HttpStatus.NOT_FOUND.value(),
				"Enter valid amount");
	...
	/**
	 * Exception Handler for handling NotEnoughBalanceException
	 */
	@ExceptionHandler(NotEnoughBalanceException.class)
	public ResponseEntity<ExceptionDetails> handleNotEnoughAmountException(NotEnoughBalanceException e) {

		ExceptionDetails response = new ExceptionDetails(LocalDateTime.now(), HttpStatus.BAD_REQUEST.value(),
				"No enough balance for proceeding this transaction");
	...
	public ResponseEntity<ExceptionDetails> handleAccessDeniedException(AccessDeniedException e) {
		...
		ExceptionDetails response = new ExceptionDetails(LocalDateTime.now(), HttpStatus.UNAUTHORIZED.value(),
				"Not Allowed");
	...
	/**
	 * Exception Handler for handling InvalidTransactionException
	 */
